...
import com.lockminds.tayari.CartActivity.Companion.createCartIntent
...
import com.lockminds.tayari.model.CartItem
...
import com.lockminds.tayari.viewModels.CartItemViewModel
import com.lockminds.tayari.viewModels.CartItemViewModelFactory
...
class MenuActivity : BaseActivity() {
    ...
    private fun launchCart(){
        GlobalScope.launch {
            ...
            runOnUiThread {
                startActivity(createCartIntent(this@MenuActivity,restaurant))
                finish()
            }
        }
    }
